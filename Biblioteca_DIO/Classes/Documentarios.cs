...
{
    public class Documentario : EntidadeBase
    {
        ...
        public Documentario(int id, Genero genero, string titulo, string descricao, int ano, double avaliacaoImdb, int classificacaoEtaria)
        {
            this.Id = id;
            this.Genero = genero;
            this.Titulo = titulo;
